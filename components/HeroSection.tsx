    ...
    <section className="relative w-full min-h-[85vh] bg-[#07070a] text-white overflow-x-hidden pt-12 pb-24 px-6 md:px-10 font-sans">
      <div className="max-w-7xl mx-auto w-full flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-8 relative z-10">
        ...
        <div className="flex-1 flex flex-col items-start w-full z-20">
          ...
          {/* Social Icons */}
          <div className="flex items-center gap-2 lg:gap-4 text-gray-300">
            ...
            <a href="https://x.com" target="_blank" rel="noreferrer" className="p-3 lg:p-2 hover:text-white hover:scale-110 transition-all duration-200">
            ...
            <a href="mailto:contact@example.com" className="p-3 lg:p-2 hover:text-white hover:scale-110 transition-all duration-200">
        ...
        <div className="flex-1 relative w-full flex justify-center lg:justify-end z-10 mt-8 lg:mt-0">
          ...
          <div className="relative w-full max-w-[340px] lg:max-w-[420px] z-10 flex flex-col items-center">
            ...
            <div className="absolute -top-6 left-2 md:left-0 lg:top-8 lg:-left-28 transform -rotate-[8deg] flex flex-col items-center z-30">
              ...
              {/* Arrow curving towards the image */}
            ...
            {/* Right-side Dashed Line Decoration (behind image) */}
            ...
            {/* Added z-10 here to ensure the portrait sits on top of the dashed background SVG */}
