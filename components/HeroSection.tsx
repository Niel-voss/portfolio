...
export default function HeroSection() {
  return (
    <section className="relative w-full min-h-[85vh] bg-[#07070a] text-white overflow-x-hidden pt-12 pb-24 px-6 md:px-10 font-sans">
      <div className="max-w-7xl mx-auto w-full flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-8 relative z-10">
        ...
        <div className="flex-1 flex flex-col items-start w-full z-20">
          ...
          {/* Social Icons (Brightened and added scale transition for UX) */}
          <div className="flex items-center gap-7 text-gray-300">
            {/* GitHub */}
            <a href="https://github.com" target="_blank" rel="noreferrer" className="hover:text-white hover:scale-110 transition-all duration-200">
            ...
            {/* X / Twitter */}
            <a href="https://x.com" target="_blank" rel="noreferrer" className="hover:text-white hover:scale-110 transition-all duration-200">
            ...
            {/* LinkedIn */}
            <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="hover:text-white hover:scale-110 transition-all duration-200">
            ...
            {/* Email */}
            <a href="mailto:contact@example.com" className="hover:text-white hover:scale-110 transition-all duration-200">
